...
struct Cliente
{
	...
	float precio;
	char estado;
}cliente0 = {"Andres Vargas", 15,24.45, 'M'}, cliente1, cliente2, cliente3, *cliente4, *cliente5, cliente6;
...
int main()
{
	...
	cin.getline(cliente6.nombre,50,'\n');
	cout<<" numero de unidades\n";
	cin>>cliente6.unidades;
	cout<<" precio\n";
	cin>>cliente6.precio;
	cout<<" estado\n";
	cin>>cliente6.estado;
	
	cout<<"los datos del cliente6 son\n";
	cout<< "nombre: "<<cliente6.nombre<<endl
	<<"numero de unidades: "<<cliente6.unidades<<endl
	<<"precio: "<<cliente6.precio<<endl
	<<"estado: "<<cliente6.estado<<endl<<endl;
